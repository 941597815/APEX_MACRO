...
# ------------------ DLL 加载 ------------------
_dll = ctypes.CDLL(os.path.join(os.path.dirname(__file__), "./rp2040_dll.dll"))
...
if __name__ == "__main__":
    try:
        time.sleep(1)
        # HIDDevice.mouse.move(129, 129)
        # HIDDevice.mouse.click()
        # HIDDevice.mouse.drag(0, 0, 100, 100)
